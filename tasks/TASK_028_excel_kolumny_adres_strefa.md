# TASK_028 — Excel: osobne kolumny dla adresu urządzenia i strefy

## Cel

Zamiast wstawiać adres i strefę do kolumny „Sekcja", dodać dwie osobne kolumny:
- **Adres** — adres Modbus urządzenia (np. `3`)
- **Strefa** — numer strefy (np. `2`); puste jeśli nie dotyczy
